...
class SolarControllerTest {
	...
	public void testSelfMadeSolarConsumerDeviceEndpoint() throws Exception {
		SelfMadeSolarSampleConsumptionDeviceDTO body = new SelfMadeSolarSampleConsumptionDeviceDTO(new Date().getTime(),0,0,null,null,0,0,null,null,null,0.f,0,null,null);
	...
	public void testSelfMadeSolarConsumerInverterEndpoint() throws Exception {
		SelfMadeSolarSampleConsumptionInverterDTO body = new SelfMadeSolarSampleConsumptionInverterDTO(new Date().getTime(),0,0,null,null,0,0,null,null,null,null,0.f,0.f,null,null);
	...
	public void testSelfMadeSolarConsumerBothEndpoint() throws Exception {
		SelfMadeSolarSampleConsumptionBothDTO body = new SelfMadeSolarSampleConsumptionBothDTO(new Date().getTime(),0,0,null,null,0,0,null,null,null,null,0.f,0.f,null,0.f,0.f,null,null);
